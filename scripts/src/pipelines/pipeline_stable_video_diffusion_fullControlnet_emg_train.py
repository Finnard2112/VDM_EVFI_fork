...
class StableVideoDiffusionPipelineControlNet(DiffusionPipeline):
    ...
    def __call__(
        ...
        controlnet_condition:  Union[PIL.Image.Image, List[PIL.Image.Image], torch.Tensor],
        height: int = 576,
        width: int = 1024,
        ...
        # '''
        # Modified by Jingxi:
        # ensure last frame conrolnet condition is zero
        # '''
        # # controlnet_condition[-1, :, :, :] = 0

        # print('controlnet condition', controlnet_condition.shape)
