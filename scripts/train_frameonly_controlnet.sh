#!/bin/bash
#SBATCH --job-name=VDM_EVFI_FRAMEONLY_BASELINE
#SBATCH --nodes=1
...
#SBATCH --output=/fs/vulcan-projects/Force_Learning/phan2003/%j_frameonly.out
#SBATCH --error=/fs/vulcan-projects/Force_Learning/phan2003/%j_frameonly.err
...
accelerate launch --num_processes=1 --mixed_precision=bf16 train_emg.py \
    ...
    --output_dir="/fs/vulcan-projects/Force_Learning/phan2003/output_frameonly_controlnet_run1" \
